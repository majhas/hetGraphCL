...
def main(args):
    ...
    metapath = np.array([node_map[n_type.strip()] for n_type in metapath])
    augmentor = Augmentor(aug_ratio=0.2, node_types=node_types, metapath=metapath, metapath_list=metapath_list)
    augs = ['dropE_not_on_metapath', 'dropE_not_on_metapath']
