...
def load_DBLP(prefix='../data/preprocessed/DBLP_processed'):
...
def load_IMDB(prefix='../data/preprocessed/IMDB_processed'):
    features = scipy.sparse.load_npz(prefix + '/features_0.npz').toarray()
...
def load_IMDB_pre_link(prefix='../data/preprocessed/IMDB_processed'):
    ...
    train_idx, val_idx = train_test_split(train_idx, test_size=0.125, random_state=1566911444)
    ...
    neg_test_edges = neg_samples[:, val_idx]

    adjM[val_edges[0], val_edges[1]] = 0
    adjM[val_edges[1], val_edges[0]] = 0

    adjM[test_edges[0], test_edges[1]] = 0
    adjM[test_edges[1], test_edges[0]] = 0
    ...
    return hg, [features_0, features_1, features_2], adjM, train_val_test_edges
...
def load_data(dataset, remove_self_loop=False):
    if dataset == 'ACM':
        ...
        return load_IMDB()
    elif dataset == 'IMDB_pre_link':
        return load_IMDB_pre_link()
    else:
