...
def main(args):
    ...
    augmentor = Augmentor(aug_ratio=0.4, node_types=node_types, metapath='paper,author,paper', metapath_list=metapath_list)
    ...
    for i in range(1):
        ...
        for epoch in range(args['num_epochs']):
            ...
            if coin_flip < -1:
                ...
                print(g.adj().shape)
                node_features = np.concatenate((features, features_1, features_2), axis=1)
                ...
                _, out1 = model(x1, hg1, epoch, opt, no_loss=True)
                _, out2 = model(x2, hg2, epoch, opt, no_loss=True)
